    ...
    <footer className="platform-footer">
      <div className="footer-container">
        ...
        <div className="footer-col">
          ...
          <p>
            منصة تعليمية تهدف إلى ربط الطلاب بالمدرسين والدورات التعليمية في
            مكان واحد، لتسهيل الوصول إلى المعرفة والتعلم بطريقة حديثة.
          </p>
        </div>
        ...
        <div className="footer-col">
          ...
          <ul>
            ...
            <li>
              <a href="#submit-course">إضافة دورة</a>
            </li>
            <li>
        ...
        <div className="footer-col">
          ...
          <a
            className="direct-logo"
            href="mailto:sudanteach@gmail.com"
            aria-label="Email"
          >
            <div className="social-icon">
            ...
            <p> sudanteach.platform@gmail.com</p>
          </a>
          <div className="footer-social">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61585006871278"
              className="social-icon"
              target="_blank"
            >
            ...
            <a
              href="https://www.instagram.com/sudanteach"
              className="social-icon"
              target="_blank"
            >
